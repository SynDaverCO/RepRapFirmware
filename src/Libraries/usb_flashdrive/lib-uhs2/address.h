...
public:
  ...
  virtual UsbDevice* GetUsbDevicePtr(uint8_t addr) override {
  ...
  virtual uint8_t AllocAddress(uint8_t parent, bool is_hub = false, uint8_t port = 0) override {
    /* if (parent != 0 && port == 0)
  ...
  virtual void FreeAddress(uint8_t addr) override {
