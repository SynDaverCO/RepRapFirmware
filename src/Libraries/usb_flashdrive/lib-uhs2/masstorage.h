...
public:
  ...
  virtual uint8_t GetAddress() override { return bAddress; }

  // UsbConfigXtracter implementation
  void EndpointXtract(uint8_t conf, uint8_t iface, uint8_t alt, uint8_t proto, const USB_FD_ENDPOINT_DESCRIPTOR *ep) override;

  virtual bool DEVCLASSOK(uint8_t klass) override { return klass == USB_CLASS_MASS_STORAGE; }
